...
<p class="case__note">Related research-data experience (different project): acknowledgements on the CoronaNet harmonization article — see <a href="{{ '/showcase/coronanet/' | relative_url }}">CoronaNet</a> and <a href="https://www.nature.com/articles/s41597-023-02881-x" target="_blank" rel="noopener">the Nature/Scientific Data article</a>.</p>
